...
// Display book->author update form on GET.
exports.author_update_get = function(req, res, next) {

    // Get book, authors and genres-> author for form.
    async.parallel({
        author: function(callback) {
            Author.findById(req.params.id).exec(callback);
        },
...
// Handle book-> author update on POST.
exports.author_update_post = [
    ...
    body('date_of_death', 'date_of_death must not be empty').isLength({ min: 1 }).trim(),
